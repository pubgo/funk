...
func (g *GoMigrate) List() ([]*MigrationWrap, error) {
	...
	var mm = make([]*MigrationWrap, 0, len(g.migrations))
...
func (g *GoMigrate) Cmd() *redant.Command {
	return &redant.Command{
		...
		Children: []*redant.Command{
			...
			{
				Use:   "migrate_to",
				Short: "migrate_to <name>",
				Handler: func(ctx context.Context, i *redant.Invocation) error {
					return g.MigrateTo(lo.FirstOrEmpty(i.Args))
				},
			},
			{
				Use:   "rollback",
			...
			{
				Use:   "rollback_to",
				Short: "rollback_to <name>",
				Handler: func(ctx context.Context, i *redant.Invocation) error {
					return g.RollbackTo(lo.FirstOrEmpty(i.Args))
				},
			},
