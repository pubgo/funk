...
var file_errorpb_errors_proto_rawDesc = []byte{
	...
	0x03, 0x5f, 0x69, 0x64, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x70, 0x75, 0x62, 0x67, 0x6f, 0x2f, 0x66, 0x75, 0x6e, 0x6b, 0x2f, 0x76, 0x32,
...
var file_errorpb_errors_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_errorpb_errors_proto_goTypes = []any{
	(*ErrMsg)(nil),    // 0: errors.ErrMsg
	(*ErrCode)(nil),   // 1: errors.ErrCode
	nil,               // 2: errors.ErrMsg.TagsEntry
	(Code)(0),         // 3: errors.Code
	(*anypb.Any)(nil), // 4: google.protobuf.Any
}
var file_errorpb_errors_proto_depIdxs = []int32{
	2, // 0: errors.ErrMsg.tags:type_name -> errors.ErrMsg.TagsEntry
	3, // 1: errors.ErrCode.status_code:type_name -> errors.Code
	4, // 2: errors.ErrCode.details:type_name -> google.protobuf.Any
